...
describe "Cistern::Model" do
  context "inspection engine" do
    ...
    it "should use default" do
      Sample.new(id: 1, name: "name").inspect.should match /#<Sample:0x[0-9a-f]{12} attributes={id:1,name:\"name\"}/
    end
